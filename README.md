...
### 🎵 オーディオ機能
- **リアルタイムオーディオ解析**: Web Audio API を使用した高精度な音声解析
- **複数のファイル形式対応**: MP3、WAV、OGG などの一般的な音声ファイルをサポート
- **音声制御**: 再生、一時停止、音量調整
...
- **カスタマイズ可能な色設定**: 波形と周波数バーの色をカスタマイズ
- **中央画像表示**: 円形ビジュアライザーの中央に画像を配置
- **高解像度レンダリング**: 1024x500 の高品質Canvas描画

### 🎯 ユーザー体験
- **レスポンシブデザイン**: モバイル、タブレット、デスクトップに対応
- **美しいUI**: Tailwind CSS による現代的なダークテーマ
- **直感的な操作**: ドラッグ&ドロップでのファイル選択
